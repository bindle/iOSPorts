...
#define PG_VERSION_STR "PostgreSQL 9.2.4 on x86_64-apple-darwin12.3.0, compiled by i686-apple-darwin11-llvm-gcc-4.2 (GCC) 4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2336.11.00), 64-bit"
